# Why Vite [​](https://vitejs.dev/guide/why#why-vite)

## The Problems [​](https://vitejs.dev/guide/why#the-problems)
...
### Slow Server Start [​](https://vitejs.dev/guide/why#slow-server-start)
...
- **Dependencies** are mostly plain JavaScript that do not change often during development. Some large dependencies (e.g. component libraries with hundreds of modules) are also quite expensive to process. Dependencies may also be shipped in various module formats (e.g. ESM or CommonJS).
    ...
    Vite [pre-bundles dependencies](https://vitejs.dev/guide/dep-pre-bundling) using [esbuild](https://esbuild.github.io/). esbuild is written in Go and pre-bundles dependencies 10-100x faster than JavaScript-based bundlers.
...
<img src="./images/001_why_vite.png" style="border-radius: 10px; margin: 35px 0px 35px 20px"  /> 
...
### Slow Updates [​](https://vitejs.dev/guide/why#slow-updates)
...
## Why Bundle for Production [​](https://vitejs.dev/guide/why#why-bundle-for-production)

Even though native ESM is now widely supported, shipping unbundled ESM in production is still inefficient (even with HTTP/2) due to the additional network round trips caused by nested imports. To get the optimal loading performance in production, it is still better to bundle your code with tree-shaking, lazy-loading and common chunk splitting (for better caching).

Ensuring optimal output and behavioral consistency between the dev server and the production build isn't easy. This is why Vite ships with a pre-configured [build command](https://vitejs.dev/guide/build) that bakes in many [performance optimizations](https://vitejs.dev/guide/features#build-optimizations) out of the box.

## Why Not Bundle with esbuild? [​](https://vitejs.dev/guide/why#why-not-bundle-with-esbuild)
...
## How is Vite Different from X? [​](https://vitejs.dev/guide/why#how-is-vite-different-from-x)

You can check out the [Comparisons](https://vitejs.dev/guide/comparisons) section for more details on how Vite differs from other similar tools.

[Suggest changes to thi](https://github.com/vitejs/vite/edit/main/docs/guide/why.md)